...
public class EnergyPlanControlledLoadV1 extends EnergyPlanControlledLoad {
    @OneToOne(cascade = CascadeType.ALL)
    @JoinTable(
            name = "e_c_loads_s_rate",
            joinColumns = @JoinColumn(name = "c_load_id"),
            inverseJoinColumns = @JoinColumn(name = "s_rate_id"))
    private EnergyPlanControlledLoadSingleRateV1 singleRate;
    ...
    private List<EnergyPlanControlledLoadTimeOfUseRatesV1> timeOfUseRates = new ArrayList<>();
    ...
    public EnergyPlanControlledLoadSingleRateV1 getSingleRate() {
        return singleRate;
    }

    public void setSingleRate(EnergyPlanControlledLoadSingleRateV1 singleRate) {
    ...
    public List<EnergyPlanControlledLoadTimeOfUseRatesV1> getTimeOfUseRates() {
        return timeOfUseRates;
    }

    public void setTimeOfUseRates(List<EnergyPlanControlledLoadTimeOfUseRatesV1> timeOfUseRates) {
    ...
    public boolean equals(Object o) {
        ...
        EnergyPlanControlledLoadV1 energyPlanControlledLoad = (EnergyPlanControlledLoadV1) o;
