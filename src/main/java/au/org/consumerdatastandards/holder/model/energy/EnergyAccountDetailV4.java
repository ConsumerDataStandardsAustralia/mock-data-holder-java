...
public class EnergyAccountDetailV4 implements EnergyAccountDetail {
    ...
    private List<EnergyAccountDetailPlansV4> plans = new ArrayList<>();
    ...
    public EnergyAccountDetailV4 accountId(String accountId) {
    ...
    public EnergyAccountDetailV4 accountNumber(String accountNumber) {
    ...
    public EnergyAccountDetailV4 displayName(String displayName) {
    ...
    public EnergyAccountDetailV4 creationDate(LocalDate creationDate) {
    ...
    public EnergyAccountDetailV4 plans(List<EnergyAccountDetailPlansV4> plans) {
        this.plans = plans;
        return this;
    }

    public EnergyAccountDetailV4 addPlansItem(EnergyAccountDetailPlansV4 plansItem) {
    ...
    @NotNull
    @Valid
    public List<EnergyAccountDetailPlansV4> getPlans() {
        return plans;
    }

    public void setPlans(List<EnergyAccountDetailPlansV4> plans) {
        this.plans = plans;
    }
    @ApiModelProperty
    ...
    public boolean equals(Object o) {
        ...
        EnergyAccountDetailV4 energyAccountDetail = (EnergyAccountDetailV4) o;
    ...
    public String toString() {
        ...
        sb.append("class EnergyAccountDetailV4 {\n");
