...
public class BankingScheduledPaymentV1 implements BankingScheduledPayment {
    ...
    public BankingScheduledPayment paymentSet(List<BankingScheduledPaymentSetV1> paymentSet) {
        this.paymentSet = paymentSet;
        return this;
    }

    public BankingScheduledPayment addItem(BankingScheduledPaymentSetV1 paymentSetItem) {
        this.paymentSet.add(paymentSetItem);
        return this;
    }

    @ApiModelProperty(required = true)
    public List<BankingScheduledPaymentSetV1> getPaymentSet() {
        return paymentSet;
    }

    public void setPaymentSet(List<BankingScheduledPaymentSetV1> paymentSet) {
        this.paymentSet = paymentSet;
    }
    ...
    public boolean equals(Object o) {
        ...
        BankingScheduledPaymentV1 bankingScheduledPayment = (BankingScheduledPaymentV1) o;
    ...
    public String toString() {
        return "class BankingScheduledPaymentV1 {\n" +
