...
public class EnergyPlanContractV1 implements EnergyPlanContract {
    ...
    public EnergyPlanContract solarFeedInTariff(List<EnergyPlanContractSolarFeedInTariffV1> solarFeedInTariff) {
        this.solarFeedInTariff = solarFeedInTariff;
        return this;
    }

    public EnergyPlanContract addSolarFeedInTariffItem(EnergyPlanContractSolarFeedInTariffV1 solarFeedInTariffItem) {
    ...
    public String toString() {
        ...
        sb.append("class EnergyPlanContractV1 {\n");
