...
public class BankingAccountDetailV2 extends BankingAccountV1 implements BankingAccountDetail {
    ...
    public boolean equals(Object o) {
        ...
        BankingAccountDetailV2 bankingAccountDetail = (BankingAccountDetailV2) o;
    ...
    protected void writeProperties(PrintWriter pw) {
        ...
        pw.print("   bsb: "); pw.println(toIndentedString(bsb));
        pw.print("   accountNumber: "); pw.println(toIndentedString(accountNumber));
        pw.print("   bundleName: "); pw.println(toIndentedString(bundleName));
        pw.print("   specificAccountUType: "); pw.println(toIndentedString(specificAccountUType));
        pw.print("   termDeposit: "); pw.println(toIndentedString(termDeposit));
        pw.print("   creditCard: "); pw.println(toIndentedString(creditCard));
        pw.print("   loan: "); pw.println(toIndentedString(loan));
        pw.print("   depositRate: "); pw.println(toIndentedString(depositRate));
        pw.print("   lendingRate: "); pw.println(toIndentedString(lendingRate));
        pw.print("   depositRates: "); pw.println(toIndentedString(depositRates));
        pw.print("   lendingRates: "); pw.println(toIndentedString(lendingRates));
        pw.print("   features: "); pw.println(toIndentedString(features));
        pw.print("   fees: "); pw.println(toIndentedString(fees));
        pw.print("   addresses: "); pw.println(toIndentedString(addresses));
    }
}
