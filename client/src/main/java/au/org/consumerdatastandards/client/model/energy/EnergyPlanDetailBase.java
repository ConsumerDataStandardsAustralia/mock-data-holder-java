...
public abstract class EnergyPlanDetailBase implements EnergyPlanDetail {
    ...
    public boolean equals(Object o) {
        ...
        EnergyPlanDetailBase energyPlanDetail = (EnergyPlanDetailBase) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(planId, effectiveFrom, effectiveTo, lastUpdated, displayName, description, type, fuelType, brand, brandName, applicationUri, additionalInformation, customerType, geography, meteringCharges);
    }
