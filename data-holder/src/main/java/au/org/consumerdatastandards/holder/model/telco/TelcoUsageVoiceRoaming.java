...
public class TelcoUsageVoiceRoaming   {
   ...
   * @return duration
  */
  @ApiModelProperty(required = true, value = "Total duration (hours, minutes, and seconds) of roaming voice calls. Not limited to 24hrs")
  @NotNull
   ...
   * @return number
  */
  @ApiModelProperty(required = true, value = "Number of roaming voice calls")
  @NotNull
   ...
   * @return amount
  */
  @ApiModelProperty(required = true, value = "Cost amount of roaming voice calls")
  @NotNull
