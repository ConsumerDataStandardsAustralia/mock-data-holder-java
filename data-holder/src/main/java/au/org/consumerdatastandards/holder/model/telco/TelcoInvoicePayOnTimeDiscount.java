...
public class TelcoInvoicePayOnTimeDiscount   {
  ...
  */
  @ApiModelProperty(required = true, value = "The amount that will be discounted if the invoice is paid by the date specified")
  @NotNull
  ...
  */
   ...
   * @return date
  */
  @ApiModelProperty(required = true, value = "The date by which the invoice must be paid to receive the pay on time discount")
  @NotNull
