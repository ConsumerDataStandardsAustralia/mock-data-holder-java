...
import au.org.consumerdatastandards.holder.configuration.OAuth2RestTemplateConfigurer.ServiceAccountEnabled;
...
public class OAuth2RestTemplateConfigurer {
  ...
  private static final Logger LOG = (Logger) LoggerFactory.getLogger(OAuth2RestTemplateConfigurer.class);
