...
public class TelcoUsageVoiceInternational   {
   ...
   * @return duration
  */
  @ApiModelProperty(required = true, value = "Total duration (hours, minutes, and seconds) of international voice calls. Not limited to 24hrs")
  @NotNull
   ...
   * @return number
  */
  @ApiModelProperty(required = true, value = "Number of international voice calls")
  @NotNull
   ...
   * @return amount
  */
  @ApiModelProperty(required = true, value = "Cost amount of international voice calls")
  @NotNull
