...
import au.org.consumerdatastandards.holder.model.telco.TelcoAccountUsageServices;
...
public class TelcoAccountUsage   {
   ...
   * @return accountId
  */
  @ApiModelProperty(required = true, value = "Tokenised ID of the account. In accordance with [CDR ID permanence](#id-permanence) requirements")
  @NotNull
