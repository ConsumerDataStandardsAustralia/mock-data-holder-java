...
public interface BankingPayeesApi {
    ...
    @ApiOperation(value = "Get Payee Detail", nickname = "getPayeeDetail", notes = "Obtain detailed information on a single payee", response = ResponseBankingPayeeById.class, tags={  })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Get Payees", nickname = "listPayees", notes = "Obtain a list of pre-registered payees", response = ResponseBankingPayeeList.class, tags={  })
    @ApiResponses(value = { 
