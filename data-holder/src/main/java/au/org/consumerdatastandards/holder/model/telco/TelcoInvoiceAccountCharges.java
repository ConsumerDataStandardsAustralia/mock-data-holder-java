...
import au.org.consumerdatastandards.holder.model.telco.TelcoInvoiceAccountChargesOtherCharges;
...
public class TelcoInvoiceAccountCharges   {
  ...
  */
  @ApiModelProperty(required = true, value = "The aggregate total of usage charges for the period covered by the invoice (exclusive of GST)")
  @NotNull
  ...
  */
  @ApiModelProperty(required = true, value = "The aggregate total of any once off charges arising from usage for the period covered by the invoice (exclusive of GST)")
  @NotNull
  ...
  */
  @ApiModelProperty(required = true, value = "The aggregate total of account level discounts or credits for the period covered by the invoice")
  @NotNull
