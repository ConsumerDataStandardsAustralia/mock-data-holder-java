...
import au.org.consumerdatastandards.holder.model.telco.TelcoBillingAccountTransactionAdjustments;
...
public class TelcoBillingAccountTransaction   {
  ...
  */
   ...
   * @return amount
  */
  @ApiModelProperty(required = true, value = "The amount charged or credited for this transaction prior to any adjustments being applied.  A negative value indicates a credit")
  @NotNull
