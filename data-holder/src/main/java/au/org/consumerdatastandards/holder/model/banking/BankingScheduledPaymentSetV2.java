...
public class BankingScheduledPaymentSetV2 implements BankingScheduledPaymentSet {
    ...
    @JoinTable(
            name = "b_sched_pay_set_tos",
            joinColumns = @JoinColumn(name = "set_id"),
            inverseJoinColumns = @JoinColumn(name = "to_id"))
    private BankingScheduledPaymentToV2 to;
    ...
    public BankingScheduledPaymentSet to(BankingScheduledPaymentToV2 to) {
        this.to = to;
        return this;
    }

    @ApiModelProperty(required = true)
    public BankingScheduledPaymentToV2 getTo() {
        return to;
    }

    public void setTo(BankingScheduledPaymentToV2 to) {
        this.to = to;
    }
    ...
    public boolean equals(Object o) {
        ...
        BankingScheduledPaymentSetV2 bankingScheduledPaymentSet = (BankingScheduledPaymentSetV2) o;
    ...
    public String toString() {
        return "class BankingScheduledPaymentSetV2 {\n" +
