...
public interface BankingProductsApi {
    ...
    @RequestMapping(value = "/banking/products/{productId}", produces =  MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.GET)
