...
public class TelcoProductDetailMeteringCharges   {
  ...
  */
   ...
   * @return minimumValue
  */
  @ApiModelProperty(required = true, value = "Minimum value of the charge if the charge is a range or the absolute value of the charge if no range is specified")
  @NotNull
