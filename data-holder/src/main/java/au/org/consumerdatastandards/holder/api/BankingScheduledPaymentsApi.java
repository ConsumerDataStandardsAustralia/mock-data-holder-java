...
public interface BankingScheduledPaymentsApi {
    ...
    @ApiOperation(value = "Get Scheduled Payments for Account", nickname = "listScheduledPayments", notes = "Obtain scheduled, outgoing payments for a specific account", response = ResponseBankingScheduledPaymentsList.class, tags={  })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Get Scheduled Payments For Specific Accounts", nickname = "listScheduledPaymentsSpecificAccounts", notes = "Obtain scheduled payments for a specified list of accounts", response = ResponseBankingScheduledPaymentsList.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Success", response = ResponseBankingScheduledPaymentsList.class),
