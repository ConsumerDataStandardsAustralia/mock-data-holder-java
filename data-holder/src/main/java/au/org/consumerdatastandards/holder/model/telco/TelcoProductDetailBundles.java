...
import au.org.consumerdatastandards.holder.model.telco.TelcoProductDetailFeature;
...
public class TelcoProductDetailBundles   {
   ...
   * @return displayName
  */
  @ApiModelProperty(required = true, value = "The display name of the product bundle")
  @NotNull
