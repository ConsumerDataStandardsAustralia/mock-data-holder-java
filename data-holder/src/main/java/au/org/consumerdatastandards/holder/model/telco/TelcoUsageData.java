...
import au.org.consumerdatastandards.holder.model.telco.TelcoUsageDatRoaming;
...
public class TelcoUsageData   {
   ...
   * @return upload
  */
  @ApiModelProperty(required = true, value = "Amount of data uploaded in megabytes (MB)")
  @NotNull
   ...
   * @return download
  */
  @ApiModelProperty(required = true, value = "Amount of data downloaded in megabytes (MB)")
  @NotNull
  ...
  */
   ...
   * @return amount
  */
  @ApiModelProperty(required = true, value = "Cost amount of data usage")
  @NotNull
