...
Where `x.x.x` is the version, say, `1.8.0`

Run locally-built image:

    docker run -p 8383:8383 consumerdatastandardsaustralia/data-holder:1.8.1-SNAPSHOT
...
Example:
    ...
    java -Dserver=http://localhost:8383/cds-au/v1 -jar target/client-cli-1.8.0.jar

or

    java -Dserver=http://localhost:8383/cds-au/v1 -jar target/client-cli-1.8.1-SNAPSHOT.jar