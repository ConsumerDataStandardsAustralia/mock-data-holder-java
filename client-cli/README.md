...
Example:
    ...
    java -Dserver=http://localhost:8383/cds-au/v1 -jar target/client-cli-2.0.0.jar

or

    java -Dserver=http://localhost:8383/cds-au/v1 -jar target/client-cli-2.0.1-SNAPSHOT.jar