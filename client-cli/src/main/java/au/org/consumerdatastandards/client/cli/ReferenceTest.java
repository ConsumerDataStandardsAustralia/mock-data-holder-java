...
public class ReferenceTest extends ApiCliBase {
    ...
    private final static Type[] responseModels = {
            ...
            new TypeToken<BankingScheduledPayment<BankingScheduledPaymentToV1>>() {}.getType(),
            new TypeToken<BankingScheduledPayment<BankingScheduledPaymentToV2>>() {}.getType(),
            ...
            new TypeToken<BankingScheduledPaymentSet<BankingScheduledPaymentToV1>>() {}.getType(),
            new TypeToken<BankingScheduledPaymentSet<BankingScheduledPaymentToV2>>() {}.getType(),
            new TypeToken<BankingScheduledPaymentToV1>() {}.getType(),
            ...
            new TypeToken<ResponseBankingAccountById<BankingAccountDetailV2>>() {}.getType(),
            new TypeToken<ResponseBankingAccountById<BankingAccountDetailV3>>() {}.getType(),
            new TypeToken<ResponseBankingAccountList<BankingAccountV1>>() {}.getType(),
            new TypeToken<ResponseBankingAccountList<BankingAccountV2>>() {}.getType(),
            new TypeToken<ResponseBankingAccountListData<BankingAccountV1>>() {}.getType(),
            new TypeToken<ResponseBankingAccountListData<BankingAccountV2>>() {}.getType(),
            ...
            new TypeToken<ResponseBankingScheduledPaymentsList<BankingScheduledPaymentToV1>>() {}.getType(),
            new TypeToken<ResponseBankingScheduledPaymentsList<BankingScheduledPaymentToV2>>() {}.getType(),
            new TypeToken<ResponseBankingScheduledPaymentsListData<BankingScheduledPaymentToV1>>() {}.getType(),
            new TypeToken<ResponseBankingScheduledPaymentsListData<BankingScheduledPaymentToV2>>() {}.getType(),
